...
## ATUALIZAÇÃO DE EXECUÇÃO — 2026-09-25 — FECHO DOS PEDIDOS UX / ENGAGEMENT

Os cinco pedidos apresentados foram reconciliados com GitHub e com o Roadmap oficial.

- Sticky: compacto/transparente e persistente no topo após recolher — implementação final na PR #38.
- Navegação: sem quebra de linha durante a transição — implementação final na PR #38.
- Mobile: navegação sobe mais no recolhimento — implementação final na PR #38.
- Coração: apenas ícone junto à partilha, persistente em D1, sem contador público — implementação final na PR #38.
...
A PR #38 ainda não está mergeada. Portanto, estas alterações não são produção.
